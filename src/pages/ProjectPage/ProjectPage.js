...
const ProjectPage = ({navState}) => {
  ...
  return (
    <div className="item-container" ref={ref}>
      ...
      <motion.section className="features-section" initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 1.2, delay: 0.5}} ref={featuresRef} exit={{y:-180, transition:{duration: 0.9, ease: [0.65, 0.1, 0.25, 0.95]}}}>
